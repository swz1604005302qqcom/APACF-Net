...
class FDDataset(Dataset):
    ...
    def set_mode(self, mode, fold_index):
        ...
        if self.mode == 'test':
            ...
            #print(f"============Loaded test_list length==============: {len(self.test_list)}")#140622
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            color = cv2.imread(os.path.join(DATA_ROOT1, color), 1)
            depth = cv2.imread(os.path.join(DATA_ROOT1, depth), 1)
            ir = cv2.imread(os.path.join(DATA_ROOT1, ir), 1)
            ...
            #print("color1.shape=========", color.shape)#(36, 96, 96, 3)
            #print("depth.shape=========", depth.shape)#(36, 96, 96, 3)
            # print("ir.shape=========", ir.shape)#(36, 96, 96, 3)
            ...
            #print("image1.shape******************", image.shape)#(36, 96, 96, 9)

            image = np.transpose(image, (0, 3, 1, 2))
            #print("image2.shape+++++++++++++++++++", image.shape)#(36, 9, 96, 96)
            image = image.astype(np.float32)
